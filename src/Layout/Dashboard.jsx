...
import { FaHome, FaCalendarAlt, FaUser, FaUsers, FaPlus, FaBook, FaSignOutAlt, FaBell } from 'react-icons/fa'; // Icons for the menu
...
const Dashboard = () => {
    ...
    const navItems = (
        <ul className='p-4 text-sm font-medium'>
            {role === 'admin' ? (
                <>
                    <li className='mb-4'><NavLink to='/dashboard/tempProfile' className={({ isActive }) =>`flex items-center gap-2 ${isActive ? 'text-[#FF6B00]' : 'hover:text-gray-300 text-white'}`} end><FaHome /> Admin Home</NavLink></li>
                    ...
                    <>
                        ...
                        <div className="absolute -right-8 ml-2 px-2 py-1 bg-gray-800 text-[#FF6B00] text-xs rounded opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap z-[9999]">
                    ...
                    <li className='mb-4'><NavLink to='/dashboard/profile' className={({isActive})=>`flex items-center gap-2 whitespace-nowrap ${isActive ? 'text-[#FF6B00]' : 'hover:text-gray-300 text-white'}`}><FaUsers />Profile</NavLink></li>
                    {/* <li className='mb-4'><NavLink to='/dashboard/notifications' className={({isActive})=>`flex items-center gap-2 whitespace-nowrap ${isActive ? 'text-[#FF6B00]' : 'hover:text-gray-300 text-white'}`}><FaBell />Notifications</NavLink></li> */}
                    
                </>
            ) : role === 'organizer' ? (
                <>
                    <li className='mb-4'><NavLink to='/dashboard/tempProfile' className={({ isActive }) =>`flex items-center gap-2 ${isActive ? 'text-[#FF6B00]' : 'hover:text-gray-300 text-white'}`} end><FaHome /> Organizer Home</NavLink></li>
                ...
                <>
                    <li className='mb-4'><NavLink to='/dashboard/registeredEvents' className={({isActive})=>`flex items-center gap-2 whitespace-nowrap ${isActive ? 'text-[#FF6B00]' : 'hover:text-gray-300 text-white'}`}><FaCalendarAlt />My Registered Events</NavLink></li>
                    <li className='mb-4'><NavLink to='/dashboard/tempProfile' className={({ isActive }) =>`flex items-center gap-2 ${isActive ? 'text-[#FF6B00]' : 'hover:text-gray-300 text-white'}`}><FaUser /> User Profile</NavLink></li>
            ...
            <li className='mb-4'><NavLink to='/dashboard/notifications' className={({isActive})=>`flex items-center gap-2 whitespace-nowrap ${isActive ? 'text-[#FF6B00]' : 'hover:text-gray-300 text-white'}`}><FaBell />Notifications
    ...
    <div className="flex flex-col h-screen lg:h-full overflow-y-auto">
