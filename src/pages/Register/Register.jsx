    ...
    return (
        <div className="flex flex-col lg:flex-row justify-center min-h-screen">
            ...
            <div className="w-full lg:w-1/2 flex flex-col items-center justify-center p-4">
                ...
                <div className="lg:hidden text-center mt-8 p-2">
            ...
            {/* Right Column (Form) */}
            <div
                className="w-full lg:w-1/2 flex items-center justify-center px-8 py-2 md:py-6 md:px-16 lg:p-16 bg-white"
            >
                <motion.div
                    ...
                    <form onSubmit={handleSubmit(onSubmit)}>
                        <div className="space-y-6">
                            ...
                            <div>
                                ...
                                <label
                                    htmlFor="photoURL"
                                    className="w-full flex items-center justify-between cursor-pointer px-4 py-2 sm:py-3 text-sm rounded-lg border border-gray-300 transition-colors"
                                >
                                    <span className={`${photoFile && photoFile[0] ? 'text-black' : 'text-gray-500'}`}>
                                        {/* You can display the file name here if you wish */}
                                        {photoFile && photoFile[0] ? photoFile[0].name : "Upload Profile Photo (Optional)"}
                                    </span>
                                    <span className=" text-gray-500 border-2 px-3 py-1 rounded-md text-xs">
                                        Browse...
                                    </span>
                                </label>
                            </div>
