  ...
  return (
    <div
      ...
      className={`flex-shrink-0 w-72 p-4 rounded-xl cursor-pointer transition-all duration-200 border-2 ${
        isActive 
          ? 'border-[#FF6B00] bg-[#FF6B00] bg-opacity-5 shadow-md' 
          : 'border-gray-200 bg-white hover:border-[#FF6B00] hover:shadow-sm'
      }`}
    >
      <div className="flex items-start justify-between mb-3">
        <div className="flex-1">
          ...
          <div className="flex items-center space-x-2 mt-1">
            <span className={`px-2 py-0.5 rounded-full text-xs font-medium ${
              isActive ? 'bg-[#FF6B00] text-white' : 'bg-[#FF6B00] bg-opacity-10 text-[#FF6B00]'
            }`}>
        ...
        <div className={`p-2 rounded-lg ${
          isActive ? 'bg-[#FF6B00] bg-opacity-20' : 'bg-gray-100'
        }`}>
      ...
      <div className="space-y-2">
        ...
        <div className="flex items-center justify-between text-xs">
          <span className={`font-medium ${isActive ? 'text-[#FF6B00]' : 'text-gray-700'}`}>
        ...
        <div className="w-full bg-gray-200 rounded-full h-1.5">
          <div 
            className={`h-1.5 rounded-full transition-all duration-300 ${
              isActive ? 'bg-[#FF6B00]' : 'bg-gray-400'
            }`}
